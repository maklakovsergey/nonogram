...
public:
    ...
    inline LineStatus columnStatus(int column) const        { return _columnStatus.count()? _columnStatus[column]:LineStatus::Normal; }
    inline LineStatus rowStatus(int row) const              { return _rowStatus.   count()? _rowStatus   [row]   :LineStatus::Normal; }
